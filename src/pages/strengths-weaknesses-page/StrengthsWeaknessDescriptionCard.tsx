    ...
    <Card>
      ...
      <CardContent>
        <Typography>
          ...
          قوت رفتاریمون هستن و علاقمند هستیم این رفتارها یا ویژگی ها رو ادامه بدیم یا حتی تقویت کنیم. از طرفی رفتارهایی
          داشتیم که شاید با نگاه به گذشته و اثرات اونها، به نظرمون بیاد که باید این رفتارها رو کنار بذاریم یا روی اون
          ویژگیمون کار کنیم که اثرات منفی توی عملکردمون نداشته باشه.
        </Typography>
        <Typography>
